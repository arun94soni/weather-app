...
const WeeklyForecast = ({ data, toggleTemperatureUnit, convertTemperature, isCelcius }) => {
          ...
          return (
            ...
            >
              ...
              >
                <WeeklyForecastItem
                  type="temperature"
                  value={isCelcius ? Math.round(item.temp) + ' °C' : convertTemperature(Math.round(item.temp)) + ' °F'}
                  color="black"
                />
                <WeeklyForecastItem
                  type="clouds"
