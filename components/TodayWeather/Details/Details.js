...
import MinMaxTempWeatherDetail from './MinMaxTempWeatherDetail';

const dayMonth = getDayMonthFromDate();

const Details = ({ data, toggleTemperatureUnit, convertTemperature, isCelcius }) => {
